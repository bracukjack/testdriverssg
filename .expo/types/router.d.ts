...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(screens)/events` | `/(screens)/home` | `/(screens)/jobs` | `/(screens)/login` | `/(screens)/notifications` | `/(screens)/profile` | `/(screens)/profile/edit` | `/(screens)/promotions` | `/(screens)/register` | `/(screens)/register/SuccessScreen` | `/(screens)/register/VerifyScreen` | `/(screens)/reliefs` | `/(screens)/reliefs/create` | `/(screens)/scan` | `/(screens)/vouchers` | `/(screens)/vouchers/ActiveVoucher` | `/(screens)/vouchers/PastVoucher` | `/_sitemap` | `/events` | `/home` | `/jobs` | `/login` | `/navigations/tabNavigation` | `/notifications` | `/profile` | `/profile/edit` | `/promotions` | `/register` | `/register/SuccessScreen` | `/register/VerifyScreen` | `/reliefs` | `/reliefs/create` | `/scan` | `/utils/convertDate` | `/utils/splitByMonth` | `/vouchers` | `/vouchers/ActiveVoucher` | `/vouchers/PastVoucher`;
  type DynamicRoutes<T extends string> = `/(screens)/promotions/detail/${SingleRoutePart<T>}` | `/(screens)/reliefs/detail/${SingleRoutePart<T>}` | `/promotions/detail/${SingleRoutePart<T>}` | `/reliefs/detail/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/(screens)/promotions/detail/[id]` | `/(screens)/reliefs/detail/[id]` | `/promotions/detail/[id]` | `/reliefs/detail/[id]`;
